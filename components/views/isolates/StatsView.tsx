...
import { API_STATS } from "../../../config/apis";
import { useAuth } from "../../../middleware/AuthProvider";
import { FlatStats } from "../../../models/Isolate";
import {
  JIYHeaderContext,
  JIYOrderingContext,
  JIYRecordContext,
...
function StatsView({
  ...
  //xiaoli
  const MODULE = ""
  const PATH = "Isolates,Stats";
  const URL = URLHandler(API_STATS);
  ...
  const [records, setRecords] =
    useState<Array<JIYRecordContext<FlatStats>>>(null);
